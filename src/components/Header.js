...
const Header = () => {
    const { scrollTo, scrollToTop, activeButton, navToggle, setNavToggle } = useContext(GlobalContext);

    return (
        <header className='py-4 px-5 lg:px-10 flex justify-between shadow-lg z-10 bg-white sticky top-0'>
            ...
            {navToggle && <ul className='absolute right-10 top-16 bg-white p-5 rounded-md shadow-md align-middle flex-col lg:static lg:p-0 lg:shadow-none md:flex lg:flex-row'>
                ...
                <li className={`p-2 cursor-pointer rounded-md font-semibold hover:bg-blue-500 hover:text-white lg:ml-10 ${activeButton === 'home' && 'bg-blue-500 text-white'}`} onClick={scrollToTop}>Home</li>
